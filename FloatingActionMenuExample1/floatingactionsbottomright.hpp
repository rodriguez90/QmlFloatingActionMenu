...
class FloatingActionsBottomRight : public FloatingActions
{
...
public:
    FloatingActionsBottomRight( const QString& menuProperyName, const QString& buttonsProperyName,QQmlContext *context, QObject *parent = nullptr);
    void initialize(QObject *parent)  override final;
    void assignSlots(QObject* rootObject);
//    ~FloatingActionsBottomRight()
//    {
//        qDebug() << " ~FloatingActionsBottomRight() called";
//    }
