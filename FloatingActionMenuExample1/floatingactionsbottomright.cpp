...
void FloatingActionsBottomRight::initialize(QObject *parent)
{
    ...
    mFloatingActionButtons.append( new FloatingActionButton {parent, "","qrc:/edit.png", "blue"});
    mFloatingActionButtons.append( new FloatingActionButton {parent, tr("Add New"),"qrc:/add.png", "green"});
    mFloatingActionButtons.append( new FloatingActionButton {parent, tr("Delete Current"),"qrc:/delete.png", "red"});
}
